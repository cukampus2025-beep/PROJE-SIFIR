...
// SİLME İŞLEMİ (HATA VEREN YER DÜZELTİLDİ)
app.delete('/admin/sil/:tur/:id', async (req, res) => {
    try {
        ...
        else if (tur === 'mesaj') tablo = "iletisim_mesajlari"; // ARTIK MESAJLAR DA SİLİNİR
...
// KULLANICI KENDİ YORUMUNU SİLME
